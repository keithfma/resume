...
\cvsection{Skills}
\begin{cvskills}
\cvskill{Languages}{Python, MATLAB, C, C++, Fortran, Javascript, SQL}
\cvskill{Packages}{scipy/numpy, sklearn, flask, OpenMP, OpenMPI}
\cvskill{Tools}{Elasticsearch, PostgreSQL, MongoDB, GDAL, QGIS, Sun Grid Engine, Bash}
\end{cvskills}
